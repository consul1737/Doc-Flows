...
} from "./chunk-GV2HP2CY.js";
import {
  getSubGraphTitleMargins
} from "./chunk-H463TP75.js";
import {
  createText,
...
// node_modules/.pnpm/mermaid@11.6.0/node_modules/mermaid/dist/chunks/mermaid.core/blockDiagram-JOT3LUYC.mjs
var parser = function() {
...
var createLabel = __name((_vertexText, style, isTitle, isNode) => {
...
var edgeLabels = {};
var terminalLabels = {};
var insertEdgeLabel = __name((elem, edge) => {
...
var rectWithTitle = __name((parent, node) => {
  let classes2;
  if (!node.classes) {
    classes2 = "node default";
  } else {
...
var class_box = __name((parent, node) => {
  var _a2;
  const halfPadding = node.padding / 2;
  const rowPadding = 4;
  const lineHeight = 8;
...
//# sourceMappingURL=blockDiagram-JOT3LUYC-U75IZKV2.js.map
